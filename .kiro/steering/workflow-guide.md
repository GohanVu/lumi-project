...
4. Implement
5. Chạy đầy đủ quality gates trong container: lint, TypeScript check, test liên quan (bug fix bắt buộc có test)
6. Chỉ đổi task sang `✅ Done` khi code hoàn tất VÀ tất cả quality gates pass
7. Trong cùng session, ghi kết quả vào audit log rồi cập nhật plan; không được cập nhật một file mà bỏ file còn lại
