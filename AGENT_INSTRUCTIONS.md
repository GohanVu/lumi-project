...
| AI Agent | Cách sử dụng |
|----------|-------------|
| **Cursor** | Copy nội dung phần Instructions vào `.cursorrules` |
| **GitHub Copilot** | Copy vào `.github/copilot-instructions.md` |
| **Windsurf** | Copy vào `.windsurfrules` |
| **Claude / ChatGPT (web)** | Paste vào đầu conversation hoặc Custom Instructions |
| **Kiro** | Không cần file này — Kiro tự đọc `.kiro/steering/` |
